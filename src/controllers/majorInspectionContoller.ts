...
export const getMajorInspectionById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const majorInspection = await MajorInspectionService.getMajorInspectionById(id, locationId, userId);
...
export const updateMajorInspection = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const updatedMajorInspection = await MajorInspectionService.updateMajorInspection(id, locationId, updateData);
...
export const deleteMajorInspection = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const deleted = await MajorInspectionService.deleteMajorInspection(id, locationId);
